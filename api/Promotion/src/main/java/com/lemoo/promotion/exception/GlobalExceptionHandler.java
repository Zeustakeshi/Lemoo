...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({feign.RetryableException.class, CallNotPermittedException.class})
    public ResponseEntity<ApiResponse<?>> handleRetryableException(Exception ex) {
        ApiResponse<?> response = ApiResponse.error("Failed to call the third-party service. Please try again later.");
