          ...
          <section className="py-16 bg-gray-50 animate-slideUp">
            <Container>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
                {[
                  { icon: <Diamond fontSize="large" />, title: "Trang sức" },
                  { icon: <Watch fontSize="large" />, title: "Đồng hồ" },
                  { icon: <Diamond fontSize="large" />, title: "Trang sức" },
                  { icon: <Watch fontSize="large" />, title: "Đồng hồ" },
                ].map((item, index) => (
                  <Paper
            ...
            <Container className="grid grid-cols-1 md:grid-cols-4 gap-10">
              <div>
                <div className="flex items-center space-x-3 mb-4">
                  <ShoppingCart className="text-white" fontSize="large" />
                  <span className="text-2xl font-bold">Lemmo-Eco</span>
                </div>
                <p className="text-gray-400">
                  Điểm đến mua sắm trực tuyến đáng tin cậy của bạn
                </p>
              </div>
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li className="hover:text-white transition">
                    <a href="#our-story">Câu chuyện của chúng tôi</a>
                  </li>
                  <li className="hover:text-white transition">
                    <a href="#blog">Blog</a>
                  </li>
