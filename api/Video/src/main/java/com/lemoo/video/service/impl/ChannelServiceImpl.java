...
public class ChannelServiceImpl implements ChannelService {
    ...
    public ChannelResponse createChannel(ChannelRequest request, AuthenticatedAccount account) {
        ...
        Channel channel = channelRepository.save(Channel
                .builder()
    ...
    public ChannelResponse updateChannel(ChannelRequest request, AuthenticatedAccount account) {
        Channel channel = channelRepository.findByUserId(account.getUserId())
                .orElseThrow(() -> new NotfoundException("This account does not have an existing channel. Please create a new channel."));
    ...
    public ChannelResponse getChannelDetail(String channelId, AuthenticatedAccount account) {
        Channel channel = channelRepository.findByActiveChannelById(channelId)
        ...
        channelResponse.setFollowed(channelFollowerRepository.existsByChannelIdAndUserId(channelId, account.getUserId()));
    ...
    public void unfollowChannel(String channelId, AuthenticatedAccount account) {
        ...
        ChannelFollower channelFollower = channelFollowerRepository.findByChannelIdAndUserId(channelId, account.getUserId())
